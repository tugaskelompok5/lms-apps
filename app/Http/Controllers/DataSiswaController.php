...
class DataSiswaController extends Controller
{
    ...
    public function contohSiswa()
    {
        ...
        $file = public_path('/examples/formatsiswasmk6.xlsx');

        return response()->download($file, 'contoh-format-siswa.xlsx');
    ...
    public function deleteMultiple(Request $request)
{
    ...
    if (empty($ids)) {
        return back()->with('delete-error', 'Tidak ada siswa yang dipilih.');
    }

    DataSiswa::whereIn('id', $ids)->delete();

    return back()->with('delete-success', 'Data siswa terpilih berhasil dihapus.');
}
