...
Route::controller(KelasMapelController::class)->group(function () {
    ...
    Route::get('/activity', 'viewAllActivities')->middleware('kepsek')->name('activity');
...
Route::controller(UjianController::class)->group(function () {
    ...
    Route::post('/selesai-ujian-multiple', 'selesaiUjianMultiple')->middleware('auth')->name('selesaiUjianMultiple');
     Route::get('/selesai-ujian-multiplev2/{token}', 'selesaiUjianMultiplev2')->middleware('auth')->name('selesaiUjianMultiplev2');
...
Route::controller(TugasController::class)->group(function () {
    ...
    Route::get('/tugasAdmin', 'viewTugasAdmin')->middleware('kepsek')->name('viewTugasAdmin');
...
Route::controller(PengajarController::class)->group(function () {
    ...
    Route::get('/data-kepsek', 'viewKepsek')->middleware('admin')->name('viewKepsek');
    Route::get('/data-pengajar/new-pengajar-1', 'viewNewPengajar')->middleware('admin')->name('viewTambahPengajar');
    Route::get('/data-kepsek/new-kepsek-1', 'viewNewKepsek')->middleware('admin')->name('viewTambahKepsek');
    ...
    Route::get('/data-kepsek/update/{token}', 'viewUpdateKepsek')->middleware('admin')->name('viewUpdateKepsek');

    Route::post('/validate-pengajar', 'validateDataPengajar')->middleware('admin')->name('validateDataPengajar');
    Route::post('/validate-kepsek', 'validateDataKepsek')->middleware('admin')->name('validateDataKepsek');
    ...
    Route::post('/update-kepsek', 'updateKepsek')->middleware('admin')->name('updateKepsek');
    Route::post('/destroy-pengajar', 'destroyPengajar')->middleware('admin')->name('destroyPengajar');
    Route::post('/destroy-kepsek', 'destroyKepsek')->middleware('admin')->name('destroyKepsek');
...
Route::controller(KelasController::class)->group(function () {
    ...
    Route::get('/contoh-format-kelas', 'contohKelas')->middleware('admin')->name('contohKelas');
...
Route::controller(DataSiswaController::class)->group(function () {
    ...
    Route::post('/siswa/delete-multiple', [DataSiswaController::class, 'deleteMultiple'])->name('deleteMultipleSiswa');
    Route::get('/export-siswa', 'export')->middleware('admin')->name('exportSiswa');
    Route::get('/contoh-format-siswa', 'contohSiswa')->middleware('admin')->name('contohSiswa');
