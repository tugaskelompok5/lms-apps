...
@section('container')
    ...
    <div class="d-flex gap-2">
        <button class="btn btn-danger" id="delete-selected" data-bs-toggle="modal" data-bs-target="#deleteMultipleModal">
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="deleteMultipleModalLabel">Konfirmasi Hapus Banyak</h5>
                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
            </div>
            <div class="modal-body">
                Apakah Anda yakin ingin menghapus semua siswa yang dipilih?
            </div>
                                        ...
                                        <tbody>
                                            ...
                                            @foreach ($siswa as $key)
                                                <tr>
                                                    ...
                                                    <td><input type="checkbox" class="select-item" value="{{ $key->id }}"></td>
   ...
   <script>
function changeValue(itemId) {
    $('#deleteButton').val(itemId);
}

// Pakai event delegation supaya tidak hilang setelah reload / Ajax
$(document).on('click', '#delete-selected', function() {
    ...
    $('#idsToDelete').val(ids.join(','));
});
// Toggle Select All
$('#btn-select-all').on('click', function() {
    var allChecked = $('.select-item:checked').length === $('.select-item').length;
    $('.select-item').prop('checked', !allChecked);
});

$(document).on('change', '.select-item', function() {
    // bisa update UI atau logika jika perlu
});
</script>
