    ...
    <div class="col-12 ps-4 pe-4 mb-4">
        <nav aria-label="breadcrumb">
            <ol class="breadcrumb bg-white">
                <li class="breadcrumb-item"><a href="{{ route('viewKepsek') }}">Data Kepala Sekolah</a></li>
                <li class="breadcrumb-item active" aria-current="page">Update Kepala Sekolah</li>
            </ol>
        </nav>
    </div>

    <div class="ps-4 pe-4 mt-4 pt-4">
        <h2 class="display-6 fw-bold"><a href="{{ route('viewKepsek') }}"><button type="button"
                    class="btn btn-outline-secondary rounded-circle">
                    <i class="fa-solid fa-arrow-left"></i></button></a> Update Kepala Sekolah</h2>
    </div>
                ...
                <div class="">
                    <div class="mt-4">
                        <div class=" ">
                            ...
                            <form action="{{ route('updateKepsek') }}" method="POST" enctype="multipart/form-data">
                                @csrf
                                    ...
                                    <div class="bg-body-tertiary rounded-4 p-4">
                                        ...
                                        <div class="mb-3">
                                            <div class="row">
                                                ...
                                                <p class="small">Isi jika ingin mengganti password untuk Kepala Sekolah.</p>
                                            </div>
                                        </div>
                                    </div>
                                </div>
