 <ul class="navbar-nav  bg-gradient-primary  sidebar sidebar-dark accordion toggled" id="accordionSidebar">
     ...
     @if (Auth()->user()->roles_id == 2 || Auth()->user()->roles_id == 1 || Auth()->user()->roles_id == 4)
         <!-- Nav Item - Dashboard -->
     ...
     @if (Auth()->User()->roles_id == 1)
         ...
         <li class="nav-item {{ Request::is('data-kepsek*') ? 'active' : '' }} animate-btn">
             <a class="nav-link" href="{{ route('viewKepsek') }}"> <i class="fa-solid fa-chalkboard-user"></i>
